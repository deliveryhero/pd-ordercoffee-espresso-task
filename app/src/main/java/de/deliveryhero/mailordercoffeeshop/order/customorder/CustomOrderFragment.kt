package de.deliveryhero.mailordercoffeeshop.order.customorder
...
class CustomOrderFragment : androidx.fragment.app.Fragment(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val mapBinding: de.deliveryhero.mailordercoffeeshop.databinding.FragmentCustomOrderBinding = DataBindingUtil.inflate<de.deliveryhero.mailordercoffeeshop.databinding.FragmentCustomOrderBinding>(inflater, R.layout.fragment_custom_order, container, false).apply {
