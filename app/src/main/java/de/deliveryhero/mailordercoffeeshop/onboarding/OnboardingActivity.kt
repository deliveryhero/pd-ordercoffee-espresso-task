package de.deliveryhero.mailordercoffeeshop.onboarding
...
import de.deliveryhero.mailordercoffeeshop.SharedPreferencesUtil
...
class OnboardingActivity : AppCompatActivity() {
    ...
    private fun closeOnboarding() {
        startActivity(Intent(this, de.deliveryhero.mailordercoffeeshop.MainActivity::class.java))
